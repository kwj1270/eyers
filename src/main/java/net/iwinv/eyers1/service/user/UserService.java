...
public class UserService {
    ...
    public Long save(UserSaveRequestDto requestDto) {
        return userRepository.save(requestDto.toEntity()).getUser_seq();
    }
    ...
    @Transactional
    public String findId(String user_name, String user_studentnumber) {
        String id = userRepository.findId(user_name, user_studentnumber);
        if(id == null){
    ...
    @Transactional
    public String findPassword(String user_id, String user_name, String user_studentnumber) {
        String password = userRepository.findPassword(user_id, user_name, user_studentnumber);
        if(password == null){
